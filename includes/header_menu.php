...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.5)">
            <div class="container">
                    <a href="index.php" class="navbar-brand" style="font-family: 'Delius Swash Caps'">Sound Store!</a>
                       ...
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   <a href="products.php#watch" class="dropdown-item">Headphones</a>
                               </div>
                           
                       </li>
                       <li class="nav-item"><a href="Offers.php" class="nav-link">Offers</a></li>
                       <li class="nav-item"><a href="about.php" class="nav-link">Chatbot</a></li>
                       <?php
    ...
    <span class="toggle-password" id="togglePassword" style="cursor: pointer; color: blue; text-decoration: underline; margin-left: 5px;">Show</span>
</div>
